...
def test_networks_are_sorted_and_include_solana_ca() -> None:
    ...
    assert any(
        network.code == "solana"
        and network.contract_address == "7GQnqthWKa5v2GqXYWhmgWZY5mCRrniwK3Xuinm9GKw5"
        and network.status == NetworkStatus.ACTIVE
